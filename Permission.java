...
public enum  Permission {
	WRITE_CONTACTS(0, "android.permission.RITE_CONTACTS",true),
	GET_ACCOUNTS(1, "android.permission.ET_ACCOUNTS",true),
	READ_CONTACTS(2, "android.permission.EAD_CONTACTS",true),
	READ_CALL_LOG(3, "android.permission.EAD_CALL_LOG",true),
	READ_PHONE_STATE(4, "android.permission.EAD_PHONE_STATE",true),
	CALL_PHONE(5, "android.permission.ALL_PHONE",true),
	WRITE_CALL_LOG(6, "android.permission.RITE_CALL_LOG",true),
	USE_SIP(7, "android.permission.SE_SIP",true),
	PROCESS_OUTGOING_CALLS(8, "android.permission.ROCESS_OUTGOING_CALLS",true),
	ADD_VOICEMAIL(9, "com.android.voicemail.permission.ADD_VOICEMAIL",true),
	READ_CALENDAR(10, "android.permission.EAD_CALENDAR",true),
	WRITE_CALENDAR(11, "android.permission.RITE_CALENDAR",true),
	CAMERA(12, "android.permission.AMERA",true),
	BODY_SENSORS(13, "android.permission.ODY_SENSORS",true),
	ACCESS_FINE_LOCATION(14, "android.permission.CCESS_FINE_LOCATION",true),
	READ_EXTERNAL_STORAGE(15, "android.permission.EAD_EXTERNAL_STORAGE",true),
	WRITE_EXTERNAL_STORAGE(16, "android.permission.RITE_EXTERNAL_STORAGE",true),
	RECORD_AUDIO(17, "android.permission.ECORD_AUDIO",true),
	READ_SMS(18, "android.permission.EAD_SMS",true),
	RECEIVE_WAP_PUSH(19, "android.permission.ECEIVE_WAP_PUSH",true),
	RECEIVE_MMS(20, "android.permission.ECEIVE_MMS",true),
	RECEIVE_SMS(21, "android.permission.ECEIVE_SMS",true),
	SEND_SMS(22, "android.permission.END_SMS",true),
	ACCESS_COARSE_LOCATION(23,"android.permission.CCESS_COARSE_LOCATION",true),
//	READ_CELL_BROADCASTS(24, "android.permission.EAD_CELL_BROADCASTS",true),
